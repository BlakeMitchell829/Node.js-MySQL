...
function addInventory(){
	...
	connection.query("SELECT * FROM Products", function(err, data){
		...
		},
		{
			...
			connection.query("UPDATE Products SET ? WHERE ? ", [{stock_quantity: currentQty + parseInt(answer.quantity)}, {product: answer.products}], function(err, data){
				if (err) throw err;
...
function addNewProduct(){
	...
	inquirer.prompt(questions).then(function(data){
		let insertQuery = "INSERT INTO Products (product, department_name, price, stock_quantity) VALUES (?, ?, ?, ?)";
