...
function viewSaleDepartment(){
	connection.query("SELECT * FROM Departments", function(err, data){
		...
		for(var i= 0; i < data.length; i++){
			console.log("Department: " + data[i].department_name + " | " + "Department Name: " + data[i].department_name + " | " + "Over Head Cost: " + data[i].over_head_costs + " | " + "Product Sales: " + data[i].product_sales + " | " + "Total Profit: " + (data[i].total_profit - data[i].over_head_costs));
			console.log("--------------------------------------------------------------------------------------------------");
		}
	productSales();
	})
